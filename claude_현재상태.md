...
## 아직 남은 것 / 확인 필요
- **6탭 구조 3·4단계** — `docs/6탭구조_설계메모.md`의 진행 순서 참고 (고객관리 히스토리 → Q&A). 구글드라이브 연동 등 미정 사항도 그 문서에 정리됨.
- **TA 실사용 테스트 필요** — Push 후 ⚙ 관리자 화면 → TA 관리에서 자료 등록·공개 체크 → 담당자 화면 TA 탭에서 실제로 보이는지 확인 필요.
